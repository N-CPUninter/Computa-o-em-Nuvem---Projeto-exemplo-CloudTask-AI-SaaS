...
> Roteiro: [`docs/praticas/13-roteiro-aula-semanas-3-e-4.md`](https://github.com/N-CPUninter/Computa-o-em-Nuvem---Projeto-exemplo-CloudTask-AI-SaaS/blob/main/docs/praticas/13-roteiro-aula-semanas-3-e-4.md).
